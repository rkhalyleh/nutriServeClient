...
//		                    });
//		                    var itemsTable = $("<table brecipe='1' width='100%'>");
...
//		                    });
//		                    var title = $("<span>Items details for the sales recipe (" + item.salesrecipe + "):</span>");
...
//		                    
//		                    var $customButton = $("<a>")
//		                    	.html("<span style='padding-left: 5px;' id='" +linkId + "'>View Items (<span class=\"recipeTotalItems_" + getRandomNumber() + "\">" + item.items.length + "</span>)</span>")
//		                    	.click(function(e) {
